...
namespace concox_v3.Concox
{
    public class CRC16
    {
        // Nao Alterar o Codigo abaixo, função de calculo CRC16 padronizada pela CONCOX. CRC Chines exclusivo da Concox.

        public static ushort Get(byte[] data, int offset, int length)
        {
            ushort fcs = 0xFFFF;
